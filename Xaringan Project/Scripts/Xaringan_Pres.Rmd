...
# Now it's your turn to make a presentation!

- Create a header called "Load Libraries" in the file we had you create at the beginning of the presentation.
...
```{r eval=FALSE}
{r penguinplot-out, ref.label="penguinplot", echo=FALSE, message=FALSE, warning=FALSE}
```
...
---
# Adding a table on Penguins
```{r}
knitr::kable(head( penguins[, 1:8]), format = 'html', size = 50%)
```